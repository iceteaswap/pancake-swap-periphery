...
contract ExampleSlidingWindowOracle {
    ...
    function update(address tokenA, address tokenB) external {
        ...
        if (timeElapsed > periodSize) {
            (uint256 price0Cumulative, uint256 price1Cumulative, ) = IceteaOracleLibrary.currentCumulativePrices(pair);
    ...
    function consult(
        ...
        address pair = IceteaLibrary.pairFor(factory, tokenIn, tokenOut);
        ...
        (uint256 price0Cumulative, uint256 price1Cumulative, ) = IceteaOracleLibrary.currentCumulativePrices(pair);
        (address token0, ) = IceteaLibrary.sortTokens(tokenIn, tokenOut);
